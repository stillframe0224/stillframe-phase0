...
const copy = {
  ...
  pricing: {
    h2: { en: "Early Access", ja: "アーリーアクセス" },
    price: "$29",
    period: { en: "", ja: "" },
    features: {
      en: [
        "Lifetime access (Phase 0 → full launch)",
        "Unlimited cards & auto image capture",
        "8 thought types + future updates",
        "Export, API & priority support",
      ],
      ja: [
        "永久アクセス（Phase 0 → 正式版）",
        "カード無制限 & 画像自動取得",
    ...
    cta: { en: "Get Lifetime Access — $29", ja: "永久アクセス — $29" },
    urgency: {
      en: "Phase 0 special: One-time payment, lifetime access. $99 after launch.",
      ja: "Phase 0 特別価格：一度きりの支払いで永久アクセス。正式版後は$99。",
    },
  },
  waitlist: {
