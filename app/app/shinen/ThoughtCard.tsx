...
export default function ThoughtCard({
  ...
  const shadowBlur = isDragging
    ...
    ? 36
    : 24;
  const shadowSpread = isDragging
    ? -8
    : isHovered
    ? -8
    : -6;
  const shadowAlpha = isDragging
    ? 0.22
    : isHovered
    ? 0.16
    : 0.12;
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: `var(--tc-shadow-x, 0px) calc(${shadowBaseY}px + var(--tc-shadow-y, 0px)) ${shadowBlur}px ${shadowSpread}px rgba(0,0,0,${shadowAlpha})${selectedGlow ? `, ${selectedGlow}` : ""}`,
