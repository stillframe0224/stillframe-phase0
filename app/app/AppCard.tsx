...
export default function AppCard({ card, index, onDelete, onPinToggle, onFileAssign, onUpdate, onNotesSaved, files = [], isDraggable = false, isBulkMode = false, isSelected = false, onToggleSelect }: AppCardProps) {
  ...
  const monoAccent = MONO_ACCENTS[card.card_type] || "#b0b0b0";
  const monoSymbol = MONO_SYMBOLS[card.card_type] || "●";
  ...
  return (
    <div
      ...
      style={{
        ...
        minWidth: 210,
        borderRadius: 16,
        border: `1px solid ${isSelected ? "#4F6ED9" : "rgba(0,0,0,0.08)"}`,
        borderLeft: `3px solid ${isSelected ? "#4F6ED9" : monoAccent}`,
